mod_processing_server <- function(id, 
  ...
  shiny::moduleServer(id, function(input, output, session){
    ...
    processed <- shiny::eventReactive(trigger(), {
      ...
      shiny::req(!identical(selections$main_scenario, selections$comparator_scenario) &&
                   selections$main_scenario$start_year == selections$comparator_scenario$start_year &&
                   selections$main_scenario$end_year == selections$comparator_scenario$end_year &&
                   selections$main_scenario$app_version == selections$comparator_scenario$app_version)
