...
::: columns
::: {.column width="40%"}
The comparison was made by facetting on scenario to ensure the waterfalls had the same x-axis scale.
:::
...
::: columns
::: {.column width="55%"}
Beeswarms uses points to present the distribution of model runs with the y-axis indicating density.

Facetting by scenario provided an easy comparison.
:::
...
-   We tried to incorporate Shiny but it did not work.

-   We struggled to move onto further products until existing PRs were merged, due to conflicts.
