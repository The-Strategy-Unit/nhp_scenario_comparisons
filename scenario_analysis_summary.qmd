...
params:
  scenario_1: NULL
  scenario_1_runtime: NULL
  scenario_2: NULL
  scenario_2_runtime: NULL
...
scenario_1_runtime <- format(
  lubridate::as_datetime(
    params$scenario_1_runtime),
  "%Y%m%d_%H%M%S")

scenario_2 <- params$scenario_2
scenario_2_runtime <- format(
  lubridate::as_datetime(
    params$scenario_2_runtime),
  "%Y%m%d_%H%M%S")
...
**Need to sort the issue with "generate_activity_in_detail.R" script.**
