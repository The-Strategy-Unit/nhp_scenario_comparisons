---
title: "S curve for 256 runs comparison"
format: 
  html:
    self-contained: true
    fig-format: svg
...
scenarios_ip_admission_dist <- purrr::map(
  scenarios_results,
  ~ get_model_run_distribution(
    ...
    measure = "admissions",
    site_codes = NULL) |> 
    dplyr::mutate(scenario = as.factor(.x$params$model_runs))
)|> 
  purrr::list_rbind()
```
...
#| fig-width: 14
#| fig-height: 7
ecdf_compare_run_numbers <- function(data, show_origin) {
